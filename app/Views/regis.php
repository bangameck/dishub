            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <p class="signup-link register">Sudah mempunyai akun? <a href="<?= base_url(); ?>/login">Log in</a></p>
                                ...
                                <div class="field-wrapper terms_condition">
                                    <div class="n-chk">
                                        <label class="new-control new-checkbox checkbox-primary">
                                            ...
                                            <span class="new-control-indicator"></span><span>I agree to the <a href="<?= base_url(); ?>/faq"> terms and conditions </a></span>
                                        </label>
                                    </div>
