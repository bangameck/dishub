        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="<?= base_url(); ?>/bagian/add" type="button" class="btn btn-primary mb-3">Tambah Bagian</a>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $b['nm_bidang']; ?></td>
                                        <td><?= $b['b_initial']; ?></td>
                                        <td><img src="<?= base_url(); ?>/_upload/logo/<?= $b['b_foto']; ?>" alt=""></td>
                                        <td>
                                            <div class="btn-group" role="group">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                    <a class="dropdown-item" href="<?= base_url(); ?>/bagian/<?= $b['b_slug']; ?>">Detail</a>
                                                    <a class="dropdown-item" href="<?= base_url(); ?>/bagian/edit/<?= $b['b_slug']; ?>">Edit</a>
                                                    <form action="<?= base_url(); ?>/bagian/<?= $b['id_bagian']; ?>" method="post" class="d-inline">
                                                        <?= csrf_field(); ?>
